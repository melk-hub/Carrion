...
exports.ExtractInfoDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var ExtractInfoDto = function () {
    var _a;
    var _text_decorators;
    var _text_initializers = [];
    var _text_extraInitializers = [];
    return _a = /** @class */ (function () {
            function ExtractInfoDto() {
                this.text = __runInitializers(this, _text_initializers, void 0);
                __runInitializers(this, _text_extraInitializers);
            }
            return ExtractInfoDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _text_decorators = [(0, swagger_1.ApiProperty)({
                    name: 'text',
                    description: 'The text to extract information from, typically an email job offer.',
                    type: 'string',
                    example: 'Hello JohnDoe733, We are pleased to offer you the position of Software Developer at Carrion&Corp at Paris. Please find the attached offer letter and benefits package. We look forward to working with you.',
...
exports.ExtractInfoDto = ExtractInfoDto;
