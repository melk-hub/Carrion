...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, config, document, authService, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    app.enableCors({
                        origin: function (origin, callback) {
                            var allowedOrigins = ["".concat(process.env.FRONT), "".concat(process.env.BACK)];
                ...
                case 3:
                    ...
                    if (!(authService &&
                        typeof authService.initializeWebhookMonitoring === 'function')) return [3 /*break*/, 5];
                    return [4 /*yield*/, authService.initializeWebhookMonitoring()];
                case 4:
                    _a.sent();
                ...
                case 6:
                    error_1 = _a.sent();
                    console.error('Failed to initialize webhook monitoring:', error_1.message);
                    return [3 /*break*/, 7];
