...
var LoggingInterceptor = function () {
    ...
    var LoggingInterceptor = _classThis = /** @class */ (function () {
        ...
        LoggingInterceptor_1.prototype.intercept = function (context, next) {
            ...
            var url = request.url;
            var userId = ((_a = request.user) === null || _a === void 0 ? void 0 : _a.id) || 'anonymous';
            var now = Date.now();
            return next.handle().pipe((0, operators_1.tap)(function () {
                var duration = Date.now() - now;
                _this.logger.log("".concat(method, " ").concat(url, " - User: ").concat(userId, " - Duration: ").concat(duration, "ms"));
            }), (0, operators_1.catchError)(function (error) {
                var duration = Date.now() - now;
                _this.logger.error("".concat(method, " ").concat(url, " - User: ").concat(userId, " - Duration: ").concat(duration, "ms - Error: ").concat(error.message));
