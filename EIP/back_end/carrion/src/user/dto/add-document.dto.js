...
exports.AddDocumentDto = void 0;
var class_validator_1 = require("class-validator");
var swagger_1 = require("@nestjs/swagger");
var AddDocumentDto = function () {
    var _a;
    var _resume_decorators;
    var _resume_initializers = [];
    var _resume_extraInitializers = [];
    return _a = /** @class */ (function () {
            function AddDocumentDto() {
                this.resume = __runInitializers(this, _resume_initializers, void 0);
        ...
        (function () {
            ...
            _resume_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Name of the document to add',
                    example: 'CV_John_Doe.pdf',
                    minLength: 1,
                    maxLength: 255,
                }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)({ message: 'Document name cannot be empty' }), (0, class_validator_1.Length)(1, 255, {
