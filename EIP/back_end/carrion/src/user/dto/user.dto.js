...
var UserDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _password_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)({ message: 'Le mot de passe ne peut pas être vide.' }), (0, class_validator_1.MinLength)(8, {
                    message: 'The password need to be at least 8 character long',
                }), (0, class_validator_1.Matches)(constants_1.passwordRegEX, {
                    message: 'The password need at least one digit, one letter and one special caractère (@$!%*#?&).',
                })];
