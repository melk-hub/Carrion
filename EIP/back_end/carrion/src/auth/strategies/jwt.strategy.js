...
var JwtStrategy = function () {
    ...
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        ...
        function JwtStrategy_1(jwtConfiguration, authService) {
            ...
            _this.jwtConfiguration = jwtConfiguration;
            _this.authService = authService;
            return _this;
        }
        JwtStrategy_1.prototype.validate = function (payload, req) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!(refreshToken && refreshToken !== '')) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.authService.validateRefreshToken(userId, refreshToken)];
                        case 1:
                            _b.sent();
                            _b.label = 2;
                        case 2: return [2 /*return*/, this.authService.validateJwtUser(userId)];
                    }
                });
            });
        };
