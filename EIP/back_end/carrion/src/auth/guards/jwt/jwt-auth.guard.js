...
var JwtAuthGuard = function () {
    ...
    var _classThis;
    var _classSuper = (0, passport_1.AuthGuard)('jwt');
    var JwtAuthGuard = _classThis = /** @class */ (function (_super) {
        __extends(JwtAuthGuard_1, _super);
        function JwtAuthGuard_1(reflector, authService) {
        ...
        JwtAuthGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var isPublic, request, response, result, _a, refreshToken, tokens, user, refreshError_1;
                var _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 3:
                            _a = _c.sent();
                            refreshToken = (_b = request.cookies) === null || _b === void 0 ? void 0 : _b['refresh_token'];
                        ...
                        case 5:
                            ...
                            return [4 /*yield*/, this.authService.validateJwtUser(tokens.userId)];
                        case 6:
                            user = _c.sent();
                            request.user = user;
                            return [2 /*return*/, true];
                        ...
                        case 8:
                            ...
                            console.log('Token refresh failed:', refreshError_1.message);
                            return [3 /*break*/, 9];
                        case 9: 
                        // Si tout échoue, lever l'exception d'origine
                        throw new common_1.UnauthorizedException('Token expired and refresh failed');
