...
var gmail_controller_1 = require("./gmail.controller");
var gmail_service_1 = require("./gmail.service");
var auth_module_1 = require("../../auth/auth.module");
var config_1 = require("@nestjs/config");
var google_oauth_config_1 = require("../../auth/config/google-oauth.config");
...
var GmailModule = function () {
    ...
    var _classThis;
    var GmailModule = _classThis = /** @class */ (function () {
        function GmailModule_1() {
        }
        return GmailModule_1;
    }());
    __setFunctionName(_classThis, "GmailModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        GmailModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return GmailModule = _classThis;
}();
