...
var GmailController = function () {
    var _classDecorators = [(0, common_1.Controller)('webhook')];
    ...
    var GmailController = _classThis = /** @class */ (function () {
        ...
        GmailController_1.prototype.handleWebhook = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                var message, decodedData, notification, historyId, emailAddress, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.gmailService.processHistoryUpdate(emailAddress, historyId)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
                            error_1 = _a.sent();
                            this.logger.error('Failed to process history update: ' + error_1.message);
                            return [2 /*return*/, {
    ...
    (function () {
        ...
        _handleWebhook_decorators = [(0, public_decorator_1.Public)(), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, common_1.Post)('gmail'), (0, swagger_1.ApiOperation)({ summary: 'get gmail webhook' })];
