...
var NotificationController = function () {
    ...
    var NotificationController = _classThis = /** @class */ (function () {
        ...
        NotificationController_1.prototype.getAll = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    userId = req.user.id;
                    return [2 /*return*/, this.notificationService.getUserNotifications(userId)];
                });
            });
        };
        NotificationController_1.prototype.markAsRead = function (id, req) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    userId = req.user.id;
                    return [2 /*return*/, this.notificationService.toggleReadStatus(id, userId)];
                });
            });
        };
        NotificationController_1.prototype.delete = function (id, req) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    userId = req.user.id;
                    return [2 /*return*/, this.notificationService.deleteNotification(id, userId)];
                });
            });
        };
    ...
    (function () {
        ...
        _getAll_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Get user notifications' }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: 'Successfully got user notifcations',
            }), (0, swagger_1.ApiResponse)({ status: 400, description: "Can't get user notifications" }), (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }), (0, swagger_1.ApiResponse)({ status: 403, description: 'Forbidden' })];
        _markAsRead_decorators = [(0, common_1.Patch)(':id/read'), (0, swagger_1.ApiOperation)({ summary: 'Toggle notification as read' }), (0, swagger_1.ApiResponse)({
                status: 200,
        ...
        _delete_decorators = [(0, common_1.Delete)(':id'), (0, swagger_1.ApiOperation)({ summary: 'Delete a notification' }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: 'Successfully deleted notification',
            }), (0, swagger_1.ApiResponse)({ status: 400, description: "Can't delete notification" }), (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }), (0, swagger_1.ApiResponse)({ status: 403, description: 'Forbidden' })];
