        ...
        {topThreeUsers.length > 0 && (
          <div className={styles.podiumSection}>
            ...
            <div className={styles.rankingPodium}>
              {topThreeUsers[1] && (
                <div
                  className={`${styles.podiumItem} ${styles.rankSilver} ${
                    currentUser?.id === topThreeUsers[1].id
                      ? styles.currentUser
                      : ""
                  }`}
                >
              ...
              {topThreeUsers[0] && (
                <div
                  className={`${styles.podiumItem} ${styles.rankGold} ${
                    currentUser?.id === topThreeUsers[0].id
                      ? styles.currentUser
                      : ""
                  }`}
                >
              ...
              {topThreeUsers[2] && (
                <div
                  className={`${styles.podiumItem} ${styles.rankBronze} ${
                    currentUser?.id === topThreeUsers[2].id
                      ? styles.currentUser
                      : ""
                  }`}
                >
        ...
        <div className={styles.rankingSection}>
          ...
          <div className={styles.rankingList}>
            {paginatedUsers.map((user) => (
              <div
                key={user.id}
                className={`${styles.rankingItem} ${getRankClass(user)} ${
                  currentUser?.id === user.id ? styles.currentUser : ""
                }`}
              >
              ...
              <div className={styles.rankingPaginationNumbers}>
                {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                  ...
                  return (
                    <button
                      key={pageNumber}
                      className={`${styles.rankingPaginationNumber} ${
