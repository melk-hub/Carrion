...
const WeeklyGoalCard = ({
  ...
  if (loading) {
    return (
      <div className={styles.weeklyGoalCard + " loading"}>
  ...
  if (error) {
    return (
      <div className={styles.weeklyGoalCard}>
        ...
        <div
          className={styles.goalProgressContent}
  ...
  return (
    <div className={styles.weeklyGoalCard}>
      <div className={styles.cardHeader}>
        ...
        {showGoToStatsButton && (
          <button
            className={homeStyles.seeAllBtn}
      ...
      <div className={styles.goalProgressContent}>
        ...
        <div className={styles.goalMainInfo}>
          ...
          <div className={styles.timeRemaining}>{goalProgress.timeLeft}</div>
        </div>
